...
// print the array inits original order
...
//show that the array is still is its original order
...
console.log("Sorted in reverse a alphabetical order :",PlacesToVisit);