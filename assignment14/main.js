...
//Task 15
let GuestList = ["Misbah", "Bushra", "Maryam"];
...
GuestList.map((items) => console.log(`Dear ${GuestList}, You are cordially invited to dinner at my place. It would be an honor to have your company.Humaiza`));
